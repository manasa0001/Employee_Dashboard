    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-4 border-b border-blue-800">
          <h2 className="ml-12 text-xl font-bold truncate">{isAdmin ? "Admin" : "Employee"}</h2>
        </div>
        ...
        <div className="flex flex-col justify-between h-[calc(100%-4rem)] p-4">
          <ul className="space-y-4 text-lg">
            ...
            <SidebarLink to="/employee/settings" icon={<FaTools />} label="Settings" closeSidebar={closeSidebar} />
          </ul>
